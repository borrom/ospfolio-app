...
class IntrosControllerTest < ActionController::TestCase
  ...
  test "should create intro" do
    assert_difference('Intro.count') do
      post :create, intro: { btnmain: @intro.btnmain, desctitle: @intro.desctitle, subtitle: @intro.subtitle, title: @intro.title }
    end
  ...
  test "should update intro" do
    patch :update, id: @intro, intro: { btnmain: @intro.btnmain, desctitle: @intro.desctitle, subtitle: @intro.subtitle, title: @intro.title }
    assert_redirected_to intro_path(assigns(:intro))
  end
